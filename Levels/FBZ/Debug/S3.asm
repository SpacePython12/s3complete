	...
	dbglistobj Obj_Blaster,			Map_Blaster,			 $80,   0, ((0&1)<<15)+((1&3)<<13)+($500&tile_mask)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   0,   0, ((0&1)<<15)+((1&3)<<13)+($528&tile_mask)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   2,   0, ((0&1)<<15)+((1&3)<<13)+($528&tile_mask)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   4,   0, ((0&1)<<15)+((1&3)<<13)+($528&tile_mask)
