	...
	dbglistobj Obj_Spring,			Map_Spring,			 $30,   7, ((0&1)<<15)+((0&3)<<13)+($43A&tile_mask)
	dbglistobj Obj_Spring,			Map_Spring,			 $40,  $A, ((0&1)<<15)+((0&3)<<13)+($43A&tile_mask)
	...
	dbglistobj Obj_RetractingSpring,	Map_Spring,			 $81,   0, ((0&1)<<15)+((0&3)<<13)+($4A4&tile_mask)
	dbglistobj Obj_RetractingSpring,	Map_Spring,			 $90,   3, ((0&1)<<15)+((0&3)<<13)+($4B4&tile_mask)
	dbglistobj Obj_RetractingSpring,	Map_Spring,			 $A0,   6, ((0&1)<<15)+((0&3)<<13)+($4A4&tile_mask)
	dbglistobj Obj_RetractingSpring,	Map_Spring,			 $30,   7, ((0&1)<<15)+((0&3)<<13)+($43A&tile_mask)
	dbglistobj Obj_RetractingSpring,	Map_Spring,			 $40,  $A, ((0&1)<<15)+((0&3)<<13)+($43A&tile_mask)
