	...
	dbglistobj Obj_CollapsingBridge,	Map_HPZCollapsingBridge, $80,   0, ((0&1)<<15)+((2&3)<<13)+($001&tile_mask)
	dbglistobj Obj_SSZHPZTeleporter,	Map_SSZHPZTeleporter,	   0,  $A, ((0&1)<<15)+((0&3)<<13)+($52E&tile_mask)
