Snd_ICZ2_Header:
	...
	smpsHeaderVoice     Snd_ICZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $23

	smpsHeaderDAC       Snd_ICZ2_DAC
	smpsHeaderFM        Snd_ICZ2_FM1,	$18, $18
	smpsHeaderFM        Snd_ICZ2_FM2,	$00, $0D
	smpsHeaderFM        Snd_ICZ2_FM3,	$0C, $1E
	smpsHeaderFM        Snd_ICZ2_FM4,	$0C, $1E
	smpsHeaderFM        Snd_ICZ2_FM5,	$18, $20
	smpsHeaderPSG       Snd_ICZ2_PSG1,	$00, $03, $00, $00
	smpsHeaderPSG       Snd_ICZ2_PSG2,	$00, $05, $00, $00
	smpsHeaderPSG       Snd_ICZ2_PSG3,	$00, $04, $00, $00
...
Snd_ICZ2_Jump01:
	...
	smpsLoop            $00, $02, Snd_ICZ2_Jump01
	smpsSetvoice        $02
...
Snd_ICZ2_Loop01:
	...
	smpsLoop            $00, $04, Snd_ICZ2_Loop01
...
Snd_ICZ2_Loop02:
	smpsCall            Snd_ICZ2_Call00
	smpsLoop            $00, $06, Snd_ICZ2_Loop02
	smpsJump            Snd_ICZ2_Jump05
...
Snd_ICZ2_Loop00:
	...
	smpsPSGAlterVol     $04
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsLoop            $00, $03, Snd_ICZ2_Loop00
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsPSGAlterVol     $FC
	dc.b	nMaxPSG2, $08, nRst, $04
	smpsPSGAlterVol     $04
