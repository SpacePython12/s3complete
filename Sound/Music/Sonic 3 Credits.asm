Snd_CreditsS3_Header:
	smpsHeaderStartSong 3, 1
	smpsHeaderVoice     Snd_CreditsS3_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $30

	smpsHeaderDAC       Snd_CreditsS3_DAC
	smpsHeaderFM        Snd_CreditsS3_FM1,	$00, $15
	smpsHeaderFM        Snd_CreditsS3_FM2,	$0C, $0E
	smpsHeaderFM        Snd_CreditsS3_FM3,	$00, $0D
	smpsHeaderFM        Snd_CreditsS3_FM4,	$0C, $1E
	smpsHeaderFM        Snd_CreditsS3_FM5,	$00, $1A
	smpsHeaderPSG       Snd_CreditsS3_PSG1,	$F4, $05, $00, $00
	smpsHeaderPSG       Snd_CreditsS3_PSG2,	$F4, $05, $00, $00
	smpsHeaderPSG       Snd_CreditsS3_PSG3,	$23, $04, $00, $00

; FM1 Data
Snd_CreditsS3_FM1:
	smpsModSet          $01, $01, $01, $04

Snd_CreditsS3_Jump01:
	smpsSetvoice        $00
...
Snd_CreditsS3_Loop04:
	...
	smpsFMAlterVol      $03
	smpsLoop            $00, $02, Snd_CreditsS3_Loop04
	smpsJump            Snd_CreditsS3_Jump01
...
Snd_CreditsS3_Loop01:
	dc.b	nAb1, $06, nRst, nAb1, nRst, $4E
	smpsLoop            $00, $09, Snd_CreditsS3_Loop01

Snd_CreditsS3_Loop02:
	...
	smpsLoop            $00, $02, Snd_CreditsS3_Loop02

Snd_CreditsS3_Loop03:
	...
	smpsLoop            $00, $02, Snd_CreditsS3_Loop03
...
Snd_CreditsS3_Loop06:
	...
	dc.b	nC4, $60
	smpsPSGAlterVol     $03
	smpsLoop            $00, $02, Snd_CreditsS3_Loop06
	smpsPSGvoice        sTone_1D
	smpsPSGAlterVol     $FE
...
Snd_CreditsS3_Loop05:
	...
	dc.b	nAb3, $60
	smpsPSGAlterVol     $03
	smpsLoop            $00, $02, Snd_CreditsS3_Loop05
	smpsPSGAlterVol     $FE
	smpsPSGvoice        sTone_1D
	dc.b	nFs3, $30, nBb3, nAb3, nEb4, nAb3, nC4, nF3, $18, nF3, nD4, nF3
	dc.b	$0C, nF3, nFs3, $30, nBb3, nAb3, nEb4, nAb3, nC4, nF3, $18, nF3
...
Snd_CreditsS3_Loop00:
	...
	smpsLoop            $00, $02, Snd_CreditsS3_Loop00
...
Snd_CreditsS3_Jump00:
	...
	dc.b	dFloorTomS3
	smpsJump            Snd_CreditsS3_Jump00

Snd_CreditsS3_Voices:
;	Voice $00
;	$3E
