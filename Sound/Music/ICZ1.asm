...
Snd_ICZ1_Loop01:
	smpsCall            Snd_ICZ1_Call00
	smpsLoop            $00, $04, Snd_ICZ1_Loop01
...
Snd_ICZ1_Loop02:
	smpsCall            Snd_ICZ1_Call00
	smpsLoop            $00, $06, Snd_ICZ1_Loop02
...
Snd_ICZ1_Loop00:
	...
	smpsPSGAlterVol     $01
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsLoop            $00, $03, Snd_ICZ1_Loop00
	dc.b	nMaxPSG2, $04, nRst, $08
	smpsPSGAlterVol     $FF
	dc.b	nMaxPSG2, $08, nRst, $04
	smpsPSGAlterVol     $01
